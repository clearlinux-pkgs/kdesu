...
Source0  : https://download.kde.org/stable/frameworks/5.63/kdesu-5.63.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.63/kdesu-5.63.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570933908
mkdir -p clr-build
pushd clr-build

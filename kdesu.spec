...
Version  : 6.11.0
Release  : 92
URL      : https://download.kde.org/stable/frameworks/6.11/kdesu-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kdesu-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kdesu-6.11.0.tar.xz.sig
...
%setup -q -n kdesu-6.11.0
cd %{_builddir}/kdesu-6.11.0
pushd ..
cp -a kdesu-6.11.0 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Su.so.6.11.0
/usr/lib64/libKF6Su.so.6
/usr/lib64/libKF6Su.so.6.11.0

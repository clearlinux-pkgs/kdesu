...
Version  : 5.105.0
Release  : 62
URL      : https://download.kde.org/stable/frameworks/5.105/kdesu-5.105.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.105/kdesu-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kdesu-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.105.0
cd %{_builddir}/kdesu-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681146640
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/frameworks/5.104/kdesu-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kdesu-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.104.0
cd %{_builddir}/kdesu-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679528365
mkdir -p clr-build
pushd clr-build

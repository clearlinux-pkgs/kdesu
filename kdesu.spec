...
Source0  : https://download.kde.org/stable/frameworks/5.69/kdesu-5.69.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.69/kdesu-5.69.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.69.0
cd %{_builddir}/kdesu-5.69.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586898727
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdesu-5.69.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdesu/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kdesud5

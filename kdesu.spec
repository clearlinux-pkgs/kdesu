...
Version  : 5.102.0
Release  : 58
URL      : https://download.kde.org/stable/frameworks/5.102/kdesu-5.102.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.102/kdesu-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/kdesu-5.102.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.102.0
cd %{_builddir}/kdesu-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673895452
mkdir -p clr-build
pushd clr-build

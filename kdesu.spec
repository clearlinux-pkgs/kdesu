...
Source0  : https://download.kde.org/stable/frameworks/5.97/kdesu-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/kdesu-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.97.0
cd %{_builddir}/kdesu-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660519213
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/frameworks/5.59/kdesu-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/kdesu-5.59.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1560034298
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar

...
Version  : 5.100.0
Release  : 56
URL      : https://download.kde.org/stable/frameworks/5.100/kdesu-5.100.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.100/kdesu-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/kdesu-5.100.0.tar.xz.sig
...
%prep
%setup -q -n kdesu-5.100.0
cd %{_builddir}/kdesu-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448363
mkdir -p clr-build
pushd clr-build

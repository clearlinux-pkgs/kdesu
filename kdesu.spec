...
Source0  : https://download.kde.org/stable/frameworks/5.58/kdesu-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/kdesu-5.58.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557779280
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
